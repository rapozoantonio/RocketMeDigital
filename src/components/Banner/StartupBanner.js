                    ...
                    <div className="col-lg-5 offset-lg-1 d-flex align-items-center">
                        <Fade bottom cascade>
                            <div className="agency_content_two">
                                <h1 className="f_700 f_size_40 l_height50 w_color mb_20">Cansado de perder dinheiro com influenciadores digitais?</h1>
                                <p className="f_400 w_color l_height28">Nossa startup tech combina marketing de influencing com os ambientes digitais da sua operação para te dar lucro e fazer você parar de perder tempo e dinheiro.</p>
