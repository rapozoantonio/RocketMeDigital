const ServiceData = {
    ...
    HRService: [
        {
            id: '1',
            HRtitles: 'Desenvolvimento de Sites',
            HRdescription: 'Criamos sites personalizados que não apenas se destacam, mas servem como o principal ponto de contato digital da sua marca, envolvendo seu público com design e inovação de ponta. Transforme seu site em um motor de crescimento incessante.',
            Hicon: 'panel',
            rclass: 'pr_70',
            iclass: 'icon_one',
        },
        {
            id: '2',
            HRtitles: 'Desenvolvimento de E-commerce',
            HRdescription: 'Construa uma plataforma de e-commerce robusta conosco, projetada para escalabilidade e desempenho. Impulsione suas vendas online e domine o mercado digital com nossas soluções de e-commerce personalizadas.',
            Hicon: 'shopping-cart',
            rclass: 'pl_50 pr_20',
            iclass: 'icon_two',
        },
        {
            id: '3',
            HRtitles: 'Soluções em Nuvem',
            HRdescription: 'Aproveite soluções de nuvem seguras e escaláveis para catapultar as operações do seu negócio para uma nova era de eficiência. Minimize custos e maximize a flexibilidade com nossos serviços de nuvem sob medida.',
            Hicon: 'cloud',
            rclass: 'pl_70',
            iclass: 'icon_three',
        },
        {
            id: '4',
            HRtitles: 'Automação de Processos Robóticos',
            HRdescription: 'Revolucione sua eficiência operacional com soluções personalizadas de RPA. Automatize tarefas rotineiras, liberando sua equipe para o que realmente importa, e testemunhe um salto significativo na produtividade.',
            Hicon: 'vector',
            rclass: 'pr_70',
            iclass: 'icon_four',
        },
        {
            id: '5',
            HRtitles: 'Inteligência Artificial',
            HRdescription: 'Implante soluções de IA de última geração para transformar dados em insights acionáveis, aprimorar a tomada de decisão e revolucionar as experiências dos usuários. Deixe a inteligência conduzir seu negócio para frente.',
            Hicon: 'panel',
            rclass: 'pl_50 pr_20',
            iclass: 'icon_five',
        },
        {
            id: '6',
            HRtitles: 'Inovação e Agilidade',
            HRdescription: 'Acelere o desenvolvimento de produtos e a inovação com nossas metodologias ágeis, adaptadas ao ritmo do seu mercado. Mantenha-se à frente da curva e adapte-se rapidamente às demandas de mercado em constante mudança.',
            Hicon: 'bolt',
            rclass: 'pl_70',
            iclass: 'icon_six',
        }
